...
export type DownloadMode = 'download' | 'play' | 'public-play' | 'purchase' | 'operator-download' | 'operator-play';
...
export type DownloadFile = {
   ...
   * public-play: پلیر عمومی تأییدشدهٔ آپرا، بدون خرید و بدون محدودیت اپراتور
