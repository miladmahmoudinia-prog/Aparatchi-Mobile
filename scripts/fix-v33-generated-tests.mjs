...
await fs.writeFile('scripts/tests/first-install-freshness-v33.test.mjs', source, 'utf8');
console.log('Rewrote v33 generated regression with syntax-safe assertions.');
