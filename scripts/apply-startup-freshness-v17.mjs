...
const appliedMarker = 'Bootstrap transport is finished before the large index begins';
...
if (!source.includes(appliedMarker)) throw new Error('startup freshness marker missing after patch');
if (!source.includes('    }, 5600);')) throw new Error('5.6-second startup escape timer missing after patch');

await fs.writeFile(file, source, 'utf8');
console.log('Cold-start freshness patch is applied and rerun-safe.');
